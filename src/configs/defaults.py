...
_C.CONTEXT = CN()
_C.CONTEXT.USE_CONTEXT = False
_C.CONTEXT.USE_HISTORY = False
_C.CONTEXT.MAX_CONTEXT_OBJECTS = 32
_C.CONTEXT.HISTORY_LEN = 5
_C.CONTEXT.DET_FEAT_DIM = 64
_C.CONTEXT.HIST_FEAT_DIM = 64
_C.CONTEXT.ATTN_HEADS = 4
_C.CONTEXT.DISTANCE_THRESH = 60.0
_C.CONTEXT.SCORE_THRESH = 0.3
_C.CONTEXT.TOPK = 32
_C.CONTEXT.DIST_ALPHA = 0.6
_C.CONTEXT.SCORE_ALPHA = 0.4

# Training noise corruption to match inference conditions
_C.CONTEXT.TRAIN_NOISE = CN()
_C.CONTEXT.TRAIN_NOISE.ENABLE = True
_C.CONTEXT.TRAIN_NOISE.DROPOUT_PROB = 0.3
_C.CONTEXT.TRAIN_NOISE.POS_NOISE_STD = 0.2
_C.CONTEXT.TRAIN_NOISE.SIZE_NOISE_STD = 0.1
_C.CONTEXT.TRAIN_NOISE.ROT_NOISE_STD = 0.05
_C.CONTEXT.TRAIN_NOISE.SCORE_NOISE_STD = 0.1

# Context dropout for robustness during training
_C.CONTEXT.CTX_DROPOUT = 0.3
